        ...
        >
          ...
          <div className="space-y-5 pb-12 text-slate-200">
            ...
            <div className="py-3 px-1 border-b border-[#212B38]/40 space-y-3">
              ...
              <ul className="space-y-2.5 text-xs sm:text-sm text-slate-300">
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#70C7BA] mt-1.5 shrink-0" />
                  <span>
                    <strong className="text-slate-100">Programmable Scripts</strong> — Scripts can enforce stateful rules across successive spends (full transaction introspection and successor validation). This enables vaults, escrows, conditional logic, multi-stage authorization, and other applications without a global shared state.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#70C7BA] mt-1.5 shrink-0" />
            ...
            <div className="py-3 px-1 border-b border-[#212B38]/40 space-y-3">
              ...
              <ul className="space-y-3 text-xs sm:text-sm text-slate-300">
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#70C7BA] mt-1.5 shrink-0" />
                  <span>
                    <strong className="text-slate-100">Silverscript</strong> — The primary high-level language for writing single-contract (and coordinated multi-contract) state-based scripts. It compiles directly to native Kaspa Script.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#70C7BA] mt-1.5 shrink-0" />
                  <span>
                    <strong className="text-slate-100">Argent</strong> — An actor-based language and compiler built on top of Silverscript for complex, stateful, multi-contract and multi-app applications. Developers express applications as communicating actors with typed state, entries, routes, and atomic transaction-wide transitions. Argent lowers cleanly into auditable Silverscript, handling routing, template commitments, Inter-Contract Communication, and successor validation automatically. It is the intended higher-level surface for sophisticated DeFi, multi-party protocols, and applications that require several contracts to interact atomically in a single transaction.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#70C7BA] mt-1.5 shrink-0" />
            ...
            <div className="py-3 px-1 leading-relaxed text-xs sm:text-sm text-slate-200">
              <p>
                In short, Kaspa combines Bitcoin’s foundational principles (fair launch, proof-of-work, UTXO model, no central control) with modern high-speed settlement and a complete, UTXO-native programmability stack centered on programmable scripts, Silverscript, and Argent.
              </p>
            </div>
          </div>
        </motion.div>
